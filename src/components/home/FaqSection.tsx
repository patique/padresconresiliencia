...
export default function FaqSection() {
    ...
    const faqs = [
        ...
        {
            q: "¿Tengo garantía?",
            a: "Sí. Queremos que compres con confianza. Tienes 15 días de garantía de devolución si el contenido no cumple con tus expectativas."
        },
        {
            q: "¿Necesito ayuda extra?",
            a: (
                <>
                    Si tienes alguna duda técnica o sobre qué recurso elegir, <button onClick={() => setIsContactOpen(true)} className="text-[#E07A5F] font-bold hover:underline">escríbenos a través del formulario de contacto</button> y te orientaremos encantados.
                </>
            )
        }
    ];
