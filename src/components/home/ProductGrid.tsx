        ...
        <>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
                ...
                {availableProducts.map((product) => {
                    const productUrl = product.slug === 'bienestar-emocional-padres'
                        ? '/bienestar-padres-primer-ano'
                    ...
                    return (
                        <div key={product.id} className="group flex flex-col bg-white rounded-2xl border border-stone-200 overflow-hidden hover:shadow-xl hover:shadow-stone-200/50 transition-all duration-300 transform hover:-translate-y-1">
                            <a href={productUrl} className="relative aspect-[4/3] bg-stone-100 overflow-hidden">
                                {product.imageUrl ? (
                                    <Image
                            ...
                            <div className="p-6 flex-1 flex flex-col">
                                ...
                                <div className="mt-auto flex items-center justify-between pt-6 border-t border-stone-100">
                                    ...
                                    <a href={productUrl} className="bg-stone-900 text-white px-5 py-2.5 rounded-lg text-sm font-semibold hover:bg-[#E07A5F] transition-colors">
                                        Ver Detalles
                                    </a>
                                </div>
                            </div>
