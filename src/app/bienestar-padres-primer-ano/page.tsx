    ...
    return (
        <div className="min-h-screen bg-slate-50 text-slate-800 font-sans">
            ...
            <main>
                ...
                <section className="py-24 bg-white text-base md:text-lg">
                    <div className="container mx-auto px-6 max-w-4xl">
                        <h2 className="text-3xl lg:text-5xl font-extrabold text-center text-slate-900 mb-8 leading-tight">
                            Nadie te avisó de que el amor más grande de tu vida vendría acompañado de tanto <span className="text-emerald-600">ruido</span>.
                        </h2>
                        ...
                        <div className="space-y-6 text-slate-600 mb-12 leading-relaxed">
                            ...
                            <p>
                                La realidad del primer año te atropella: La culpa por querer salir corriendo 5 minutos. La sensación de que tu pareja y tú sois compañeros de piso gestionando una empresa de pañales. El "ruido mental" constante de si lo estarás haciendo bien.
                            </p>
                            <p className="font-medium text-slate-900 bg-emerald-50 p-4 border-l-4 border-emerald-500 rounded-r-lg">
                                Te han vendido que ser padres es instintivo y maravilloso todo el tiempo. <strong>Mentira.</strong> Es maravilloso, sí. Pero también es agotador, sucio y a veces, solitario.
                            </p>
                            <p>
                                He creado este método porque yo también me rompí. Y descubrí que <strong>no es cuestión de "aguantar más", sino de tener mejores herramientas.</strong>
                            </p>
                        </div>

                        <div className="bg-slate-50 rounded-3xl p-8 md:p-12 border border-slate-100 shadow-sm">
                            <h3 className="text-2xl font-bold text-slate-900 mb-8 text-center">En este programa no te enseño a cambiar pañales. Te enseño a:</h3>
                            <div className="grid md:grid-cols-2 gap-6">
                                <div className="flex gap-4">
                                    <div className="bg-emerald-100 text-emerald-700 rounded-full p-2 h-fit shrink-0"><Check className="w-5 h-5" /></div>
                                    <div>
                                        <h4 className="font-bold text-slate-900">Blindar tu descanso</h4>
                                        <p className="text-slate-600 text-sm">Estrategias reales para dormir (tú y el bebé) sin dejarle llorar.</p>
                                    </div>
                                </div>
                                <div className="flex gap-4">
                                    <div className="bg-emerald-100 text-emerald-700 rounded-full p-2 h-fit shrink-0"><Check className="w-5 h-5" /></div>
                                    <div>
                                        <h4 className="font-bold text-slate-900">Desactivar la bomba de la pareja</h4>
                                        <p className="text-slate-600 text-sm">Cómo hablaros bonito cuando estáis a punto de explotar.</p>
                                    </div>
                                </div>
                                <div className="flex gap-4">
                                    <div className="bg-emerald-100 text-emerald-700 rounded-full p-2 h-fit shrink-0"><Check className="w-5 h-5" /></div>
                                    <div>
                                        <h4 className="font-bold text-slate-900">Gestionar la "opinología"</h4>
                                        <p className="text-slate-600 text-sm">Poner límites a suegros y cuñados sin culpa y con elegancia.</p>
                                    </div>
                                </div>
                                <div className="flex gap-4">
                                    <div className="bg-emerald-100 text-emerald-700 rounded-full p-2 h-fit shrink-0"><Check className="w-5 h-5" /></div>
                                    <div>
                                        <h4 className="font-bold text-slate-900">Recuperar tu identidad</h4>
                                        <p className="text-slate-600 text-sm">Recordar quién eras tú antes de ser "mamá/papá de...".</p>
                                    </div>
                                </div>
                            </div>
                        </div>

                        <p className="text-center text-xl font-medium text-slate-800 mt-12">
                            Deja de sobrevivir a la crianza. Empieza a disfrutarla. <br />
                            <span className="text-emerald-600 font-bold">Tu hijo no necesita unos padres perfectos; necesita unos padres cuerdos y felices.</span>
                        </p>
                    </div>
                </section>
